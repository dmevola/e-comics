...
const ComicList = ({ items, title }) => {
  ...
  return (
    <div className='w-full pt-10 md:pt-5 pb-0 items-center h-full grid md:grid-cols-2 xl:grid-cols-3 mx-2 row-start-auto shadow-none outline-none bg-blue-400 space-evenly'>
      {items && 
      items.map(item => (
